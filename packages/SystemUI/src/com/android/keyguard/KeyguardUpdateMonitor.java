...
import static android.os.BatteryManager.EXTRA_QUICK_CHARGER;
...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
		...
		final boolean quickChargeStatus = intent.getBooleanExtra(EXTRA_QUICK_CHARGER, false);
                final Message msg = mHandler.obtainMessage(
                        MSG_BATTERY_UPDATE, new BatteryStatus(status, level, plugged, health,
                                maxChargingMicroWatt, quickChargeStatus));
	...
	public static final int CHARGING_QUICK = 3;
	...
	public final boolean quickChargeStatus;
        public BatteryStatus(int status, int level, int plugged, int health,
                int maxChargingWattage, boolean quickChargeStatus) {
            this.status = status;
            this.level = level;
        ...
        public final int getChargingSpeed(int slowThreshold, int fastThreshold) {
            return quickChargeStatus ? CHARGING_QUICK :
	...
	// change in quick charging while plugged in
        if (nowPluggedIn && current.quickChargeStatus != old.quickChargeStatus) {
            return true;
        }
