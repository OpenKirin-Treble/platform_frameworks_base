...
public final class BatteryService extends SystemService {
    ...
    private boolean mQuickCharger;
    private boolean mHasQuickCharger;
    private boolean mLastQuickCharger;
	...
	mHasQuickCharger = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_hasQuickCharge);
	...
	mQuickCharger = mHasQuickCharger && isQuickCharger();
		...
		mInvalidCharger != mLastInvalidCharger ||
                mQuickCharger != mLastQuickCharger)) {
	    ...
	    mLastQuickCharger = mQuickCharger;
        }
    }
	...
	intent.putExtra(BatteryManager.EXTRA_QUICK_CHARGER, mQuickCharger);
        if (DEBUG) {
    ...
    private boolean isQuickCharger() {
        try {
            FileReader file = new FileReader("/sys/class/power_supply/Battery/fcp_status");
